...
function slide() {
  ...
  var duration = slidecount > 33 ? 1500 : (slidecount > 32 ? 800 : (slidecount > 25 ? 400 : (slidecount > 20 ? 200 : (slidecount > 15 ? 150 : 100))));

  var cardInfo = getNextCardText();

  card = $('<div class="card">' + '<div class="title">' + cardInfo.title + '</div>' + '<div class="desc">' + cardInfo.desc + '</div>' + '</div>');
  tail.after(card);
  tail = card;
  slidecount++;
